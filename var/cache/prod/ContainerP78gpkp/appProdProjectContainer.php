...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory(array())) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'tienda', 'user' => 'admin', 'password' => 'Pelu3713..toledo', 'charset' => 'UTF8', 'driverOptions' => array(1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'), 'serverVersion' => 5.1, 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array('enum' => 'string'));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b->setNamingStrategy(${($_ = isset($this->services['prestashop.database.naming_strategy']) ? $this->services['prestashop.database.naming_strategy'] : $this->services['prestashop.database.naming_strategy'] = new \PrestaShopBundle\Service\Database\DoctrineNamingStrategy('tienda_')) && false ?: '_'});
    ...
    {
        return $this->services['prestashop.database.naming_strategy'] = new \PrestaShopBundle\Service\Database\DoctrineNamingStrategy('tienda_');
    }
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('yCFcNC3XXiE1YY6pABJpBh1BWe1zpOS0AHwzVAaAC9IJ10ARmgUdVEPq')) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('yCFcNC3XXiE1YY6pABJpBh1BWe1zpOS0AHwzVAaAC9IJ10ARmgUdVEPq');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_user' => 'admin',
            'database_password' => 'Pelu3713..toledo',
            'database_prefix' => 'tienda_',
            'database_engine' => 'InnoDB',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => 'yCFcNC3XXiE1YY6pABJpBh1BWe1zpOS0AHwzVAaAC9IJ10ARmgUdVEPq',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2018-08-05',
            'locale' => 'es-ES',
            'cookie_key' => 'i9hfWn1qYs2WZe7vZnp1gEf2EI6AWnxtd5N1d7o4wp3cOKsbsLWdp9wc',
            'cookie_iv' => 'QHLdIPog',
            'new_cookie_key' => 'def000005116d953e4bc6c2dfbb1d30fb5d0f2537aa59592a5dc3b553b9b1e012a4c82736f8de647e3f56e5a9f50928553fd922b2b5ec10a2b1f6e7b02e82e1352547495',
            'cache.driver' => 'array',
            ...
            'kernel.secret' => 'yCFcNC3XXiE1YY6pABJpBh1BWe1zpOS0AHwzVAaAC9IJ10ARmgUdVEPq',
